...
#include <memory>
#include "../../../../main/gui/PropertyPanel.h"
...
QT_MOC_LITERAL(1, 14, 12), // "paramChanged"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "PropertyPanel\0paramChanged\0"
};
...
void PropertyPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PropertyPanel::paramChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PropertyPanel::paramChanged()
{

...
QT_MOC_LITERAL(1, 5, 13), // "paramsChanged"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 13), // "outputUpdated"
QT_MOC_LITERAL(4, 34, 9) // "portIndex"

    },
    "Node\0paramsChanged\0\0outputUpdated\0"
    "portIndex"
};
...
void Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->outputUpdated((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Node::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Node::paramsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Node::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Node::outputUpdated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Node::paramsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Node::outputUpdated(int _t1)
{
